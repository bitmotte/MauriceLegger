public static class ConfigProperties
{
	public static class Local
	{
		...
		public const string DisabledComputeShaders = "disabledComputeShaders";
		...
		public const string DisableHitParticles = "disableHitParticles";

		public const string DisableHeatwaves = "disableHeatwaves";
		...
		public const string CyberGrindFogState = "cyberGrind.fogState";

		public const string CyberGrindFogColor = "cyberGrind.fogColor";

		public const string CyberGrindFogStartDistance = "cyberGrind.fogStartDistance";

		public const string CyberGrindFogEndDistance = "cyberGrind.fogEndDistance";

		public const string CyberGrindFogDynamicDistance = "cyberGrind.fogDynamicDistance";
	...
	public const string MainMenuEncorePopUp = "MainMenuEncorePopUp";
